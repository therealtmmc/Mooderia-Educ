...
import { Play, FolderOpen, Layers, Brain, PieChart, ShieldCheck, X, Sparkles } from 'lucide-react';

interface DesktopLandingViewProps {
  onStartLearning: () => void;
}

export default function DesktopLandingView({ onStartLearning }: DesktopLandingViewProps) {
    ...
    <div className="min-h-screen bg-[#F8F9FC] flex flex-col items-center justify-between p-8 text-slate-900 font-sans select-none relative overflow-x-hidden">
        ...
        <div className="space-y-10">
          <div className="space-y-6">
            <motion.div 
              ...
              className="w-20 h-20 rounded-3xl bg-indigo-600 flex items-center justify-center shadow-2xl shadow-indigo-600/30 overflow-hidden p-4"
            >
            ...
            >
              Mooderia <span className="text-indigo-600">Education</span>
              <br/>
              <span className="text-3xl lg:text-4xl text-slate-400 font-bold tracking-normal leading-[1.2] block mt-2">Web Workspace.</span>
            </motion.h1>
            ...
            >
              Experience a focused, secure, and privacy-first learning environment designed for modern academics. Your workspace remains entirely offline and local.
            </motion.p>
          </div>
          ...
          >
            <button 
              ...
              className="inline-flex items-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-indigo-600/20 hover:shadow-indigo-600/40 hover:-translate-y-1"
            >
              <Play className="w-6 h-6 fill-white" />
              Start Learning
            </button>
            <div className="flex flex-col gap-1 pl-1">
              <p className="text-sm font-mono text-slate-500 font-semibold tracking-widest uppercase">Desktop Browser Experience</p>
              <p className="text-sm font-mono text-indigo-500 font-semibold tracking-widest uppercase">✨ Secured Local Environment</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex gap-6 items-start hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <p className="text-slate-500 leading-relaxed font-medium">Structure your coursework flawlessly with custom folder hierarchies and seamless resource management.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-5 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 font-medium">Create rich text documents and custom study decks seamlessly.</p>
              </div>
            </div>
          ...
          <div className="bg-indigo-600 text-white p-8 rounded-3xl shadow-xl shadow-indigo-600/20 flex gap-6 items-center hover:shadow-2xl hover:shadow-indigo-600/30 transition-shadow">
            ...
            <div>
              ...
              <p className="text-indigo-100 font-medium">Maximize retention through interactive study sessions across all your local workspaces.</p>
            </div>
          </div>
        </motion.div>
        </div>
      ...
      <div className="mt-12 flex flex-col items-center justify-center gap-6 w-full max-w-6xl border-t border-slate-200/60 pt-6">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm font-semibold text-slate-400">
          <button onClick={() => setActiveModal('terms')} className="hover:text-indigo-600 transition-colors">Terms &amp; Conditions</button>
          <button onClick={() => setActiveModal('privacy')} className="hover:text-indigo-600 transition-colors">Privacy Policy</button>
          <button onClick={() => setActiveModal('creator')} className="hover:text-indigo-600 transition-colors cursor-pointer flex-shrink-0">
            About the Creator
          </button>
        </div>
